"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[153],{6842:function(e,t,r){r.d(t,{C:function(){return signOut},W:function(){return GoogleAuthProvider},a9:function(){return createUserWithEmailAndPassword},aa:function(){return signInWithEmailAndPassword},c:function(){return signInWithPopup},o:function(){return getAuth},y:function(){return onAuthStateChanged}});var i=r(8745),n=r(3991),s=r(6914),a=r(44),o=r(5538);function _prodErrorMap(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}let l=_prodErrorMap,c=new i.LL("auth","Firebase",_prodErrorMap()),u=new s.Yd("@firebase/auth");function _logWarn(e,...t){u.logLevel<=s.in.WARN&&u.warn(`Auth (${n.Jn}): ${e}`,...t)}function _logError(e,...t){u.logLevel<=s.in.ERROR&&u.error(`Auth (${n.Jn}): ${e}`,...t)}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let S=new Delay(5e3,15e3),A={style:{position:"absolute",top:"-100px",width:"1px",height:"1px"},"aria-hidden":"true",tabindex:"-1"},k=new Map([["identitytoolkit.googleapis.com","p"],["staging-identitytoolkit.sandbox.googleapis.com","s"],["test-identitytoolkit.sandbox.googleapis.com","t"]]);function getIframeUrl(e){let t=e.config;_assert(t.authDomain,e,"auth-domain-config-required");let r=t.emulator?_emulatorUrl(t,"emulator/auth/iframe"):`https://${e.config.authDomain}/__/auth/iframe`,s={apiKey:t.apiKey,appName:e.name,v:n.Jn},a=k.get(e.config.apiHost);a&&(s.eid=a);let o=e._getFrameworks();return o.length&&(s.fw=o.join(",")),`${r}?${(0,i.xO)(s).slice(1)}`}async function _openIframe(e){let t=await _loadGapi(e),r=_window().gapi;return _assert(r,e,"internal-error"),t.open({where:document.body,url:getIframeUrl(e),messageHandlersFilter:r.iframes.CROSS_ORIGIN_IFRAMES_FILTER,attributes:A,dontclear:!0},t=>new Promise(async(r,i)=>{await t.restyle({setHideOnLeave:!1});let n=_createError(e,"network-request-failed"),s=_window().setTimeout(()=>{i(n)},S.get());function clearTimerAndResolve(){_window().clearTimeout(s),r(t)}t.ping(clearTimerAndResolve).then(clearTimerAndResolve,()=>{i(n)})}))}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
